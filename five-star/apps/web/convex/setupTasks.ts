...
const TASK_DEFINITIONS: Array<{
  ...
  { type: "discover_products", label: "Discovering menu & products", order: 3 },
  { type: "fetch_tripadvisor", label: "Importing TripAdvisor reviews", order: 4 },
  { type: "fetch_booking", label: "Importing Booking.com reviews", order: 5 },
  { type: "fetch_yelp", label: "Importing Yelp reviews", order: 6 },
